...
Estimate hand pose using MediaPipe (Python version).<br> This is a sample program that recognizes hand signs and finger gestures with a simple MLP using the detected key points. Extentions have been made in order to incorporate the recognition of various hand sign sequences, with aims of recognizing sign language text and having a functioning sign language to text interpreter that is grammatically correct. 
